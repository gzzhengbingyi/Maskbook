...
mainnet.built_in_tokens.map((x) => ({ chainId: ChainId.Mainnet, ...x })).sort(sort)
mainnet.predefined_tokens.map((x) => ({ chainId: ChainId.Mainnet, ...x })).sort(sort)
rinkeby.built_in_tokens.map((x) => ({ chainId: ChainId.Rinkeby, ...x })).sort(sort)
rinkeby.predefined_tokens.map((x) => ({ chainId: ChainId.Rinkeby, ...x })).sort(sort)
//#endregion
